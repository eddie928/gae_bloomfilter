...
try:
    ...
    raise ImportError('pybloom requires BitVector')
...
class BloomFilter(object):
    ...
    def __init__(self, capacity, error_rate=0.001):
        ...
        self.bitarray = BitVector.BitVector(intVal=0, size=self.num_bits) # TODO big endian...
    ...
    def copy(self):
        ...
        new_filter.bitarray = self.bitarray.deep_copy()
        return new_filter
...
have equal capacity and error rate")
    ...
    # eddie: I didn't convert these to BitVector cuz we don't need them
    #def tofile(self, f):
